...
public class ChunkProviderGenerate implements IChunkProvider {
    ...
    //omp
    public void a(int i, int j, final ChunkSnapshot chunksnapshot) {
                            ...
                            for (int j3 = 0; j3 < 4; ++j3) {
                                ...
                                if ((d16 += d15) > 0.0D) {
                                    ompExecutor.execute(new Runnable(){
                                        ...
                                        public void run() {
                                            {
                                                chunksnapshot.a(kf * 4 + i3f, k2f * 8 + l2f, j1f * 4 + j3f, Blocks.STONE.getBlockData());
                                            }
                                        }
                                    });
                                    ...
                                    ompExecutor.execute(new Runnable(){
                                        ...
                                        public void run() {
                                            {
                                                chunksnapshot.a(kf * 4 + i3f, k2f * 8 + l2f, j1f * 4 + j3f, s.getBlockData());
                                            }
                                        }
                                    });
    ...
    public void a(final int i, final int j, final ChunkSnapshot chunksnapshot, final BiomeBase[] abiomebase) {
        double d0 = 0.03125D;
                    ...
                    public void run() {
                        {
                            ...
                            biomebase.a(m, h, chunksnapshot, i * 16 + k, j * 16 + l, t[l + k * 16]);
                        }
                    }
                });
        }}ompExecutor.waitForExecution();       
    ...
    public Chunk getOrCreateChunk(final int i, final int j) {
        ...
        final ChunkSnapshot chunksnapshot = new ChunkSnapshot();
        ...
        //System.out.println("gen time:"+(et-st)+"ns.");
        final org.omp4j.runtime.IOMPExecutor ompExecutor = new org.omp4j.runtime.DynamicExecutor(Runtime.getRuntime().availableProcessors());
        /* === /OMP CONTEXT === */
        final ChunkProviderGenerate th = this;
        for (int ompI = 0; ompI < 4; ompI++) {
                final int ompJ = ompI;
                ompExecutor.execute(new Runnable(){
                        @Override
                        public void run() {
                        {
                                if (ompJ == 0) {
                                        if (r.r) {
                                            u.a(th, m, i, j, chunksnapshot);
                                        }
                                        if (r.z) {
                                            z.a(th, m, i, j, chunksnapshot);
                                        }
                                }
                                else if (ompJ == 1) {
                                        if (r.w && n) {
                                            x.a(th, m, i, j, chunksnapshot);
                                        }
                                        if (r.v && n) {
                                            w.a(th, m, i, j, chunksnapshot);
                                        }
                                }
                                else if (ompJ == 2) {
                                        if (r.u && n) {
                                            v.a(th, m, i, j, chunksnapshot);
                                        }
                                        if (r.x && n) {
                                            y.a(th, m, i, j, chunksnapshot);
                                        }
                                }
                                else if (ompJ == 3) {
                                        if (r.y && n) {
                                            A.a(th, m, i, j, chunksnapshot);
                                        }
                                }
        ...
        //System.out.println("abyte.length:"+abyte.length);
        chunk.initLighting();
