...
public class SpigotWorldConfig
{
    ...
    public static double chunkeMaxTickPercent;
    public static double entityMaxTickPercent;
    private void maxTickPercent()
    {
        chunkeMaxTickPercent = getDouble("max-chunk-tick-percent", 100);
        entityMaxTickPercent = getDouble("max-entity-tick-percent", 100);
        log("Chunk Max Tick Percent: " + chunkeMaxTickPercent + "% Entity max Tick Percent: " + entityMaxTickPercent + "%");
    }
}
