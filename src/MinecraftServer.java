...
import org.HOSE.hosecalc_long;
import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger; // Spigot
...
public abstract class MinecraftServer implements ICommandListener, Runnable, IMojangStatistics {
    ...
    public MinecraftServer(OptionSet options, Proxy proxy) {//softpak // CraftBukkit - signature file -> OptionSet
    ...
    // Spigot Start
    private static double calcTps(double avg, double exp, double tps)//softpak
    {
    ...
    public void run() {//softpak
        try {
            if (this.init()) {
                ...
                this.q.setServerInfo(new ServerPingServerData("1.7.9H", 5));
                this.a(this.q);
    ...
    public void v() {
        ...
        for (i = 0; i < this.worlds.size(); ++i) {//softpak
