...
public class BiomeDecorator {
    ...
    protected int K;
    public boolean L;
    protected HRandom hrndbd = new HRandom();
    ...
    public void a(World world, Random random, BiomeBase biomebase, BlockPosition blockposition) {
        if (this.a != null) {
            ...
            System.out.println("BDa Time use:"+(et-st)+"ns.");
            this.a = null;
            this.b = null;
        }
    }
    ...
    protected void a(BiomeBase biomebase) {
        ...
        for (i = 0; i < this.I; ++i) {
            j = hrndbd.nextInt(16) + 8;
            k = hrndbd.nextInt(16) + 8;
        ...
        if (this.L) {
            ...
            for (j = 0; j < 20; ++j) {
                k = hrndbd.nextInt(16) + 8;
                l = hrndbd.nextInt(16) + 8;
                i1 = hrndbd.nextInt(hrndbd.nextInt(hrndbd.nextInt(240) + 8) + 8);
                /*k = this.b.nextInt(16) + 8;
                l = this.b.nextInt(16) + 8;
